 ...
 */
public abstract class NguyenNathan extends Animal
{
  ...
  public NguyenNathan()
  {
    this("NguyenNathan", "Brown", 4); // Default is a black animal with 4 legs
  }
   ...
   */
  public NguyenNathan(String studentName, String color, int legs) {
